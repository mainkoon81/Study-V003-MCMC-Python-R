...
__Q. So..for Binomial Likelihood, why choose "Beta" as a prior?__ how to elicit prior distribution?
 ...
 - __No-data? "Estimate data points"__ with respect to θ : Prior Predictive Distribution of X
...
### **Hey! we just found the form of the prior function!! which is `Beta(a,b)` !!! 
 - __prior -> posterior__
