...
The theoretical stationary distribution for this chain is normal with mean `0` and variance `1/(1−ϕ^2)`, which in our example approximately equals `1.562`. Let’s look at a histogram of our chain and compare that with the theoretical stationary distribution.
```
hist(x, freq=FALSE)
